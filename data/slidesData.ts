...
Use o seguinte repositório para buscar a interface: {LINK_REPO}. Não se prenda a estrutura desse repositório, use-o apenas para copiar a interface visual`,
  ...
  3: [
    ...
    {
      type: 'list',
      badge: 'Revisão — Aula 02',
      title: 'Stack Completa de um Projeto',
      color: '#a78bfa',
      items: [
        '**Estrutura de um projeto**: SPA → Web App → com Integrações Internas e Externas',
        '**As 3 camadas**: Frontend (React), Backend (Laravel), Banco de Dados (MySQL)',
        '**Deploy**: Docker em servidor Linux com Nginx como proxy reverso',
        '**Vocabulário técnico**: API, endpoint, container, deploy, Makefile, CLAUDE.md',
    ...
    },
    {
      ...
      items: [
        ...
        '02 — Comandos do Makefile',
        '03 — Segurança da informação',
        '04 — Revisão crítica de código gerado por IA',
        '05 — Clonando projetos reais',
      ],
    },
    {
      type: 'content',
    ...
    },
    {
      ...
      subtitle: 'Os comandos que usamos todo dia',
      color: '#a78bfa',
      blocks: [
        {
          icon: '▶️',
          label: 'make up',
          text: 'Sobe todos os containers do projeto — app, banco de dados e nginx',
          commands: ['make up'],
        },
        {
          icon: '⏹️',
          label: 'make down',
          text: 'Para e remove todos os containers em execução',
          commands: ['make down'],
        },
        {
          icon: '📤',
          label: 'make send',
          text: 'Aplica lint, pede a mensagem de commit e envia para o repositório remoto',
          commands: ['make send'],
        },
        {
          icon: '🚀',
          label: 'make deploy',
          text: 'Puxa as atualizações, rebuilda e roda as migrations em produção',
    ...
    },
    {
      ...
      steps: [
        ...
        { num: '✅', label: 'Sempre', text: '.gitignore com .env' },
      ],
    },
    {
      type: 'list',
    ...
    },
    {
      type: 'content',
      badge: 'Parte 05',
      title: 'Clonando Projetos Reais',
      subtitle: 'Explore os projetos da Pandô APPs',
      color: '#a78bfa',
      blocks: [
        {
          icon: '📣',
          label: 'Campanhas Já',
          text: 'Plataforma de criação e gestão de campanhas digitais',
          url: 'https://github.com/pandoapps/CampanhasJ-',
          commands: ['git clone https://github.com/pandoapps/CampanhasJ-'],
        },
        {
          icon: '🃏',
          label: 'Figurex',
          text: 'Gerador de figurinhas digitais com integração de pagamentos',
          url: 'https://github.com/pandoapps/Figurex',
          commands: ['git clone https://github.com/pandoapps/Figurex'],
        },
        {
          icon: '🎬',
          label: 'VideoBoard',
          text: 'Criador de story boards e roteiros para vídeo com IA',
          url: 'https://github.com/pandoapps/videoStoryBoard',
          commands: ['git clone https://github.com/pandoapps/videoStoryBoard'],
        },
        {
          icon: '📺',
          label: 'Maratonei',
          text: 'Plataforma de acompanhamento de corridas e maratonas',
          url: 'https://github.com/pandoapps/Maratonei',
          commands: ['git clone https://github.com/pandoapps/Maratonei'],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          icon: '🦊',
          label: 'Converseiro',
          text: 'Projeto completo disponível no GitLab — explore, clone e use como referência',
          url: 'https://gitlab.com/pandoapps/converseiro',
          commands: ['git clone https://gitlab.com/pandoapps/converseiro'],
        },
      ],
    },
    {
